...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: database
--
...
ALTER TABLE public.employees OWNER TO database;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: database
--
